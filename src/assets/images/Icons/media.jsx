...
function MediaSvgIconComp_(props) {
  return (
    <svg id="Media_Icon" data-name="Media Icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
...
export default MediaSvgIconComp_;
